...
#
# Ambition beyond planter/assert (tonight 2026-09-12):
...
rng = random.Random(20260912)  # reproducible tonight; not the retention quote
n = 180
...
print("(seed Random(20260912) — not the retention quote; collision guard active)")
