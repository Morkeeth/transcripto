...
#
# Ambition beyond planter/assert (tonight 2026-09-15):
...
rng = random.Random(20260915)  # reproducible tonight; not the retention quote
n = 180
...
print("(seed Random(20260915) — not the retention quote; collision guard active)")
