...
#
# Ambition beyond planter/assert (tonight 2026-09-16):
...
rng = random.Random(20260916)  # reproducible tonight; not the retention quote
n = 180
...
print("(seed Random(20260916) — not the retention quote; collision guard active)")
