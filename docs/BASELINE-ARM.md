...
`bash scripts/pip_only_baseline.sh` (RUN 2026-09-21T00:09:29Z,
branch `cursor/night-wave-p1-launch-0583`).
...
9. **TZ pair trap:** UTC↔Tokyo agreed on `2026-08-22` while LA differed
   (`2026-08-21`). Which pair you pick decides whether divergence looks absent.
