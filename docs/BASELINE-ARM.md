...
Measured 2026-09-06. Numbers re-derived at their objects; not carried from
...
# → independent_oracle: PASS (180 blind ages, find == Python st_mtime)
# → boundary_probe: PASS
```
...
# → human_turns: 8, total_records: 21, episodes: 8
```
...
8/21 of records as human turns (re-derived tonight; do not carry %).
