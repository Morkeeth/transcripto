...
Measured 2026-09-09 ~22:19 UTC. Numbers re-derived at their objects; not
...
# → negative_planter: PASS · tz_divergence: OBSERVED · tz_pair_trap: DETECTED
...
### Embarrassing TZ pair trap (new tonight)

UTC↔LA calendar cuts **agreed** (`2026-08-10`) while Asia/Tokyo differed
(`2026-08-11`). A two-zone probe can miss divergence. Publish TZ with any
live figure.

### Embarrassing frozen-quote non-reconciliation (new tonight)
...
| TZ pair trap | UTC↔LA green while Tokyo differs | multi-zone probe |
