...
Tip: `759bc07` on `cursor/night-wave-p1-cold-verify-47f3`. Host tools in UTC
...
Host UTC tools. Final Slice-1 re-run after scripts landed (`759bc07`).
Re-derived figures — do not carry prior-wave oracle counts (tonight oracle
old30=**91**, old45=**46** under seed `20260919`).

```
=== COLD VERIFY · 2026-09-19T00:14:32Z ===
repo: /workspace
...
oldest_mtime: 2026-08-06T00:14:35Z
...
ref_duration_epoch: 1787184880
method_skew_seconds: 880
