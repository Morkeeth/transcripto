...
| CI tip `dfe42b2` | GitHub Actions `tests` workflow | test 3.9 + 3.13 + **cold-verify** all success |
...
## Footer — night wave 2026-09-21 log (branch 8b78)
...
… tz_divergence: none at this clock (all four thresholds: 2026-08-22)
...
… find_head_sigpipe_trap: DETECTED
