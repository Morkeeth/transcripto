...
cold verify green 2026-09-11 ~00:15Z · article / X = **Oscar clicks only**
...
| Cold stranger | `bash scripts/cold_verify.sh` | **PASS** — `ratio_30d: 504 of 2721`, `independent_oracle: PASS` (old30=103/old45=44), `negative_planter: PASS`, `boundary_probe: PASS`, `offline_core: PASS`, `calendar_duration_delta: none` on fixture (boundary file `counted=0`), `touch_utime_planter: PASS` (7/10), `tz_divergence: OBSERVED`, `tz_pair_trap: DETECTED` (UTC↔Tokyo agree; LA differs), `frozen_quote_reconcile: FAIL-TO-RECONCILE`, `stats_near_miss: DETECTED`, old45=0 |
...
| Cold artifact | `docs/COLD-VERIFY-2026-08-30.md` | captured command output (2026-09-11 ~00:15Z re-run) |
...
| CI | GitHub Actions tip `f766d6e` | test 3.9 + 3.13 + cold-verify all **success** |
...
1. [ ] Re-derive live retention on Oscar's machine (optional but honest):
   ...
   504/2721 and 579/2874. **Do not invent a daily death rate** (stamps
   FAIL-TO-RECONCILE). Name calendar vs duration if you switch methods.
...
## Footer — night wave 2026-09-11 log
...
… independent_oracle: PASS (old30=103, old45=44)
… boundary_probe: PASS
… duration_vs_calendar: … counted_by_bang_newermt=0
… calendar_duration_delta: none tonight (fixture ages 31–44d; skew ~950s)
… touch_utime_planter: PASS (7 of 10)
… tz_divergence: OBSERVED (UTC/Tokyo/London 2026-08-12 vs LA 2026-08-11)
...
$ # CI tip f766d6e: test 3.9 + 3.13 + cold-verify all success (run 34545928908)
$ # Main empty-index embarrassment (RUN at start): PRIVACY OK 0/0 exit 0 — fixed fail-closed
```
