...
cold verify green 2026-09-15 ~00:15Z · article / X = **Oscar clicks only**
...
| Cold artifact | `docs/COLD-VERIFY-2026-08-30.md` | captured command output (2026-09-15 ~00:15Z) |
...
| PyPI | `curl -sL https://pypi.org/pypi/transcripto/json` | **0.2.0**; wheel cold_verify entries **0** |
...
## Footer — night wave 2026-09-15 log
...
… independent_oracle: PASS (old30=81, old45=40; seed 20260915)
… boundary_probe: PASS
… duration_vs_calendar: … counted_by_bang_newermt=0
… calendar_duration_delta: none tonight (fixture ages 31–44d; skew ~910s)
… touch_utime_planter: PASS (7 of 10)
… tz_divergence: OBSERVED (UTC/Tokyo/London=2026-08-16; LA=2026-08-15)
...
$ # Intermediate FAIL (RUN): python3 -m venv without python3.12-venv printed
$ #   ensurepip missing and left a broken tree; cold_verify now refuses a
$ #   missing venv/bin/python instead of looking green.
```
