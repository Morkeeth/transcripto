...
**Cloud recommendation (2026-09-10): KEEP the current invented replay demo.**
...
rg -n 'beloeved|NO-DURABLE|worst looped|mTERMINAL' README.md || true
```

Observed at `README.md:64–88` (via `nl -ba … | sed -n '64,88p'`):
